...
venue: "Introduction to programming with Python, the Shell and version control in Git"        # brief name of host site without address 
...
instructor: ["Marc Galland", "Like Fokkens", "Jesse Kerkvliet", "Caspar Treijtel"] # boxed
helper: ["Rodrigo Silva Meneses", "Johannes De Groeve", "Misha Paauw"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
<ul>
  <li>Shell session (Thursday morning): <a href="https://etherpad.wikimedia.org/p/Shell_novice_24062021">Link</a>            </li>
  <li>Python (Thursday afternoon and Friday morning): <a href="https://etherpad.wikimedia.org/p/Python-2021-06-24">Link</a>  </li>
  <li>Version control (Friday morning): <a href="https://etherpad.wikimedia.org/p/version-control-2021-06-25">Link</a>       </li>
<br>
</ul>
</p>
<hr/>
