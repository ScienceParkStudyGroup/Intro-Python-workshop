...
venue: "Introduction to programming in Python, Unix Shell and and version control in Git"        # brief name of host site without address 
...
instructor: ["Marc Galland", "Like Fokkens", "Caspar Treijtel"] # boxed
helper: ["Like Fokkens", "Caspar Treijtel"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
